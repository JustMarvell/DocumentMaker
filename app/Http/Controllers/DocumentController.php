...
class DocumentController extends Controller
{
    ...
    public function generate(Request $request) {
        ...
        return match($documentType->key) {
            'letter-of-assignment' => $this->generateLetterOfAssignment($request, $documentType),
            'permission-letter' => $this->generatePermissionLetter($request, $documentType),
            'employee-performance-targets' => $this->generateEmployeePerformanceTargets($request, $documentType),
            default => back()->with('error', "Jenis Surat '{$documentType->key}' belum didukung."),
        };
    }
