...
class DocumentTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->seedFields($skp, [
            ['field_key' => 'appraisal_period_start', 'label' => 'Awal Periode Penilaian', 'field_type' => 'date', 'is_required' => true, 'sort_order' => 1, 'section_label' => 'Periode'],
            ['field_key' => 'appraisal_period_end', 'label' => 'Akhir Periode Penilaian', 'field_type' => 'date', 'is_required' => true, 'sort_order' => 2],
            ['field_key' => 'employee_name', 'label' => 'Nama Pegawai', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 3, 'section_label' => 'Data Pegawai', 'staff_autofill_column' => 'staff_name'],
            ['field_key' => 'employee_nip', 'label' => 'NIP', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 4, 'staff_autofill_column' => 'nip'],
            ['field_key' => 'employee_rank', 'label' => 'Pangkat / Gol. Ruang', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 5, 'staff_autofill_column' => 'rank'],
            ['field_key' => 'employee_position', 'label' => 'Jabatan', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 6, 'staff_autofill_column' => 'position'],
            ['field_key' => 'employee_work_unit', 'label' => 'Unit Kerja Pegawai', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 7, 'staff_autofill_column' => 'work_unit'],
            ['field_key' => 'appraisal_name', 'label' => 'Nama Penilai', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 8, 'section_label' => 'Data Penilai', 'staff_autofill_column' => 'staff_name'],
            ['field_key' => 'appraisal_nip', 'label' => 'NIP Penilai', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 9, 'staff_autofill_column' => 'nip'],
            ['field_key' => 'appraisal_rank', 'label' => 'Pangkat / Gol. Ruang Penilai', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 10, 'staff_autofill_column' => 'rank'],
            ['field_key' => 'appraisal_position', 'label' => 'Jabatan Penilai', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 11, 'staff_autofill_column' => 'position'],
            ['field_key' => 'appraisal_work_unit', 'label' => 'Unit Kerja Penilai', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 12, 'staff_autofill_column' => 'work_unit'],
            ['field_key' => 'leadership_work_result_plan', 'label' => 'Rencana Hasil Kerja Pimpinan', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 13, 'section_label' => 'Rencana Hasil Kerja'],
            ['field_key' => 'work_result_plan', 'label' => 'Rencana Hasil Kerja', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 14],
            ['field_key' => 'work_quantity_indicator', 'label' => 'Indikator Kuantitas', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 15],
            ['field_key' => 'work_quantity_target', 'label' => 'Target Kuantitas', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 16],
            ['field_key' => 'work_quality_indicator', 'label' => 'Indikator Kualitas', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 17],
            ['field_key' => 'work_quality_target', 'label' => 'Target Kualitas', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 18],
            ['field_key' => 'work_time_indicator', 'label' => 'Indikator Waktu', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 19],
            ['field_key' => 'work_time_target', 'label' => 'Target Waktu', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 20],
            ['field_key' => 'additional_work_behaviour_1', 'label' => 'Perilaku Kerja Tambahan', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 21, 'section_label' => 'Perilaku Kerja'],
            ['field_key' => 'additional_work_behaviour_1_description', 'label' => 'Deskripsi Perilaku Kerja', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 22],
            ['field_key' => 'leadership_spesific_expectation', 'label' => 'Ekspektasi Spesifik Pimpinan', 'field_type' => 'text', 'is_required' => true, 'sort_order' => 23],
        ]);
    }
